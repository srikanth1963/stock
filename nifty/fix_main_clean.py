...
path = '/opt/smb-algo/main.py'

# Clean, correct main.py content
content = '''"""
...
async def morning_entry_job():
    """
    9:20 AM IST — waits 30 seconds for TV webhook to arrive and update
...
print("main.py cleaned and updated — 30s wait added, duplicates removed")
